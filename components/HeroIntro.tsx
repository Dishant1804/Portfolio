...
const HeroIntro = () => {
  ...
  return (
    <div className="w-[950px] h-[403px] p-[40px] bg-heroIntro-gradient border-0 mt-[37px] rounded-[20px] flex flex-col items-start justify-center gap-[16px]">
      ...
      <button
        className='w-[163px] h-[60px] py-[20px] bg-[#0B8A56] text-[#FFF] rounded-[15px] gap-[3.5px] flex flex-row justify-center items-center border-0 hover:bg-[#6666] hover:duration-300'
