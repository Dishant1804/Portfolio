...
const ExperienceAndEducation = () => {
  return (
    <div className="flex flex-col md:flex-row w-full md:w-[1394px] h-auto md:h-[625px] justify-center">
      <div className="mt-[46px] w-full md:w-[682px] mb-4 md:mr-[30px] bg-experience-gradient h-auto md:h-full rounded-[20px]">
            ...
            <div className="flex flex-col h-auto md:h-[485px] w-full md:w-[596px] pl-[20px] md:pl-[65px]">
              <div className="w-full h-auto md:h-[161px] flex flex-row items-center border-b-2 border-[#77777D]/20">
                ...
                <div className="pl-[20px] w-auto">
                  ...
                  <h2 className="mt-[12px] h-[22px] text-[#CCC] text-[20px] md:text-[24px] font-semibold">
                    Disbound
                  </h2>
                  <h3 className="mt-[16px] h-[30px] text-[14px] md:text-[16px] pb-[31.3px] text-[#77777D]">
                    Backend Developer
                  </h3>
                </div>
              </div>
      ...
      <div className="mt-[46px] w-full md:w-[682px] h-auto md:h-full bg-education-gradient rounded-[20px]">
        <div className="w-full md:w-1/2 h-full flex flex-col md:flex-row">
          <div>
            <h2 className="w-full md:w-[191px] text-[#FFF] text-[24px] md:text-[32px] pt-[36px] pl-[20px] md:pl-[80px] font-semibold flex flex-col">
              Education
            ...
            <div className="flex flex-col h-auto md:h-[485px] w-full md:w-[596px] pl-[20px] md:pl-[47px]">
              <div className="w-full h-auto md:h-[180px] flex flex-row items-center border-b-2 border-[#77777D]/20">
                ...
                <div className="pl-[20px] w-auto">
                  ...
                  <h2 className="mt-[12px] h-[22px] text-[#CCC] text-[20px] md:text-[22px] font-semibold">
